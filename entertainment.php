...
$url = "http://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=24e6305d8f71420ea52efc77d2b1eae8";
...
<center><h1 style="border-bottom: 2px solid black;width: 40%;padding: 1em 1em .5em;">Entertainment Section</h1></center>
...
<a href="bussiness.php" class="prev-page">PrevPage</a>
<a href="general.php" class="prev-page" style="float: right;">NextPage</a>

</div>
 <!-- Footer -->
 
	<?php  require 'include/footer.inc.php'?>    <!-- Footer -->
  </body>
